...
def context_color_format_string(format_string, format_attrs):
    ...
    the format specifier with a version wrapped with log record color attributes. ie,
    ...
    #
    # The capture 'attr_name' is just the name of the attr ('process' or 'message' or 'levelname' for ex.)
    # The record attribute name is extracted so it can be used in the name of the color debug logger attribute
    # that will set the color info.
    #
...
class ColorFormatter(logging.Formatter):
    ...
    def __init__(self, fmt=None, default_color_by_attr=None, color_groups=None):
        ...
        self.color_mapper = color_mapper.TermColorMapper(fmt=self._base_fmt,

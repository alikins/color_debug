...
class DarkTermPalette(object):
    '''An indexed color palette, ie, an ordered list of strings of terminal color escape codes'''
    ...
    START_OF_COLORS = RGB_COLOR_OFFSET
    END_OF_COLORS = 231
    NUMBER_OF_COLORS = END_OF_COLORS - RGB_COLOR_OFFSET
    ...
    THREAD_COLORS = dict((color_number, color_seq) for
                         (color_number, color_seq) in [(x, "\033[38;5;%dm" % x) for x in range(START_OF_COLORS, END_OF_COLORS)])
    ALL_COLORS = {}
